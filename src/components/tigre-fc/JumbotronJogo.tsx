...
// ════════════════════════════════════════════════════════════════════════════
// NORMALIZA NOME DA COMPETIÇÃO (sem forçar nada)
// ════════════════════════════════════════════════════════════════════════════
  ...
  return (
    ...
    >
      ...
      <div className="text-center pt-2 pb-3 relative z-10">
        ...
        {local && (
          <div className="text-[9px] text-zinc-500 tracking-wider mt-0.5 px-4 truncate">📍 {local}</div>
        )}
      </div>
      ...
      {transmissao && (
        <div className="mx-4 mb-3 relative z-10 text-center">
          <span className="inline-block text-[8px] tracking-[2px] text-zinc-500 font-bold uppercase">
            📺 {transmissao}
          </span>
        </div>
      )}
      ...
      {onEscalar ? (
        <button
          ...
          style={{
            background: ctaDisabled ? '#2a2a2a'
              : hasEscalacao ? `linear-gradient(90deg, ${C.cyan}, ${C.gold})`
        ...
        <Link
          ...
          style={{
            background: hasEscalacao ? `linear-gradient(90deg, ${C.cyan}, ${C.gold})`
              : `linear-gradient(90deg, ${C.gold}, #ffaa00, ${C.gold})`,
            color: C.black,
