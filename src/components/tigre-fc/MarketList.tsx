...
export default function MarketList({ players, isEscalado, onSelect, onDragStart, onDragEnd }: MarketListProps) {
  ...
  // Mapeamento de posições baseado nos dados do seu SQL
  ...
  return (
    <div className="w-80 bg-zinc-900 border-r border-white/10 flex flex-col h-full shrink-0">
      ...
      <div className="p-4 border-b border-white/5 bg-black/20">
        <h2 className="text-xl font-black italic text-yellow-500 uppercase tracking-tighter mb-4">Mercado</h2>
            ...
            return (
              ...
              >
                ...
                <div className="ml-3 flex-1 min-w-0">
                  ...
                  <p className="text-sm font-black text-white uppercase truncate">{player.short}</p>
                </div>
