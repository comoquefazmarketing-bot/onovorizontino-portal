    ...
    async function init() {
      ...
      try {
        ...
        if (resJogo.data) {
          ...
          // BUSCA ESCALAÇÃO REAL PARA O JUMBOTRON
          if (meuUsuarioId) {
          ...
          setStatsState({
            capitao: { nome: dadosEscalacao.capitao, pts: 0.0 },
            heroi: { nome: dadosEscalacao.heroi, pts: 0.0 },
      ...
      <header className="relative pt-16 pb-28 text-center bg-black border-b border-white/5 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="inline-flex items-center gap-4 px-6 py-2 bg-white/5 rounded-full border border-white/10 backdrop-blur-md">
            <div className="w-2 h-2 rounded-full bg-cyan-400 animate-pulse shadow-[0_0_10px_#00F3FF]" />
